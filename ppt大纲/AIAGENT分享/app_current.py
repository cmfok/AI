...
# ── 幻灯片主题定义（用于 AI 分类）────────────────────
SLIDES = [
    {"page": 1,  "title": "封面",                   "tags": "封面 AI 真垃圾 分享会 开场"},
    {"page": 2,  "title": "封面-动画",               "tags": "封面 动画 开场 动效"},
    {"page": 3,  "title": "外星人的语言",            "tags": "互动 猜字 规律 LLM 预测 下一个词"},
    {"page": 4,  "title": "反认知",                  "tags": "反认知 AI 能力 预期 认知反差"},
    {"page": 5,  "title": "模型",                    "tags": "模型 大模型 能力 场景 选择"},
    {"page": 6,  "title": "四大工程总览",            "tags": "工程 总览 提示词 上下文 约束 循环 四大"},
    {"page": 7,  "title": "提示词工程 · 案例",       "tags": "提示词 工程 案例 语音 PPT 输出结构"},
    {"page": 8,  "title": "提示词工程 · 四规则",     "tags": "提示词 规则 角色 要求 参考 标准"},
    {"page": 9,  "title": "不会写提示词",            "tags": "提示词 问题 不会写 能力 瓶颈"},
    {"page": 10, "title": "上下文工程揭晓",           "tags": "上下文 工程 揭晓 RAG 知识库 背景"},
    {"page": 11, "title": "知识库搭建",              "tags": "知识库 搭建 青铜 白银 黄金 Trae Obsidian"},
    {"page": 12, "title": "招聘简历",                "tags": "招聘 简历 筛选 案例 约束 校验"},
    {"page": 13, "title": "运费对账",                "tags": "运费 对账 案例 约束 规则 数据"},
    {"page": 14, "title": "驾驭工程",                "tags": "驾驭 工程 工具 MCP 调用 验证 校验"},
    {"page": 15, "title": "脚本vs工作流",            "tags": "脚本 工作流 决策 场景 选择 哪个好"},
    {"page": 16, "title": "生日营销",                "tags": "生日 营销 案例 循环 自动 客服 回访"},
    {"page": 17, "title": "循环工程揭晓",            "tags": "循环 工程 揭晓 自查 复盘 反馈"},
    {"page": 18, "title": "个人vs企业AI",            "tags": "个人 企业 AI 对比 工程深度 玩玩 投产"},
    {"page": 19, "title": "数据隐私",                "tags": "隐私 数据 泄露 加密 安全 保护"},
    {"page": 20, "title": "落地Checklist",           "tags": "落地 Checklist 检查清单 场景 模型 提示词"},
    {"page": 21, "title": "互动答疑",                "tags": "Q&A 互动 答疑 提问 环节"},
]

# ── 幻灯片详细描述（用于 LLM 语义理解）──────────────────
SLIDE_DESCRIPTIONS = [
    {"page": 1,  "title": "封面",                  "desc": "AI 真垃圾分享会开场页，展示演讲主题"},
    {"page": 2,  "title": "封面-动画",              "desc": "封面动效页，从会用AI到驾驭工程的四个阶段动画展示"},
    {"page": 3,  "title": "外星人的语言",           "desc": "互动猜字游戏，展示LLM预测下一个词的原理，让观众理解AI底层模式识别机制"},
    {"page": 4,  "title": "反认知",                  "desc": "AI能力的反认知真相，打破对AI的误解和预期偏差"},
    {"page": 5,  "title": "模型",                    "desc": "大模型能力概览，不同场景下的模型选择和适用性"},
    {"page": 6,  "title": "四大工程总览",            "desc": "提示词工程、上下文工程、约束工程、循环工程四大AI工程全景概览"},
    {"page": 7,  "title": "提示词工程 · 案例",       "desc": "提示词工程实际案例：通过语音输入自动生成PPT，展示提示词输出结构设计"},
    {"page": 8,  "title": "提示词工程 · 四规则",     "desc": "写好Prompt的四条黄金规则：角色设定、要求明确、参考示例、质量标准"},
    {"page": 9,  "title": "不会写提示词",            "desc": "为什么很多人觉得不会写提示词？提示词能力的真实瓶颈和突破方法"},
    {"page": 10, "title": "上下文工程揭晓",           "desc": "上下文工程的核心价值——让AI知道它在跟谁打交道，RAG和知识库的作用"},
    {"page": 11, "title": "知识库搭建",              "desc": "青铜/白银/黄金三阶段知识库搭建指南：从入门到进阶的AI背景资料库"},
    {"page": 12, "title": "招聘简历",                "desc": "约束工程案例：AI招聘简历筛选的实际应用，展示规则校验和脚本工作流"},
    {"page": 13, "title": "运费对账",                "desc": "约束工程案例：运费对账规则校验，展示数据校验和异常处理机制"},
    {"page": 14, "title": "驾驭工程",                "desc": "工具调用/MCP/约束验证/状态管理/错误处理/可观测性：如何给AI套上缰绳"},
    {"page": 15, "title": "脚本vs工作流",            "desc": "决策三要素：结果类型、容错要求、规划清晰度——决定用脚本、工作流还是AI"},
    {"page": 16, "title": "生日营销",                "desc": "循环工程案例：生日营销自动化——自动扫描客户→通知→回访的闭环流程展示"},
    {"page": 17, "title": "循环工程揭晓",            "desc": "循环工程的核心机制：做→查→修→再输出，从能干到能干好的质变"},
    {"page": 18, "title": "个人vs企业AI",            "desc": "个人AI与企业AI的工程深度对比：个人省时间，企业赚钱，差在驾驭+循环"},
    {"page": 19, "title": "数据隐私",                "desc": "AI时代的数据隐私保护：加密/私有化部署/本地化方案/防泄露措施"},
    {"page": 20, "title": "落地Checklist",           "desc": "AI落地的完整检查清单：场景识别→模型选择→提示词设计→约束构建→监控运维"},
    {"page": 21, "title": "互动答疑",                "desc": "Q&A互动答疑环节，观众提问，无控制动效"},
]
